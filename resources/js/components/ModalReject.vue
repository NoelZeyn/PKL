<template>
  <div v-if="visible" class="fixed inset-0 flex items-center justify-center bg-[rgba(0,0,0,0.7)] bg-opacity-50 z-50">
    <div class="bg-white rounded-lg p-6 w-96 shadow-lg">
      ...
      <textarea v-model="reason" rows="4" placeholder="Tulis alasan penolakan..."
      ...
      <div class="flex justify-end mt-4 space-x-2">
        ...
        <button @click="confirmReject" :disabled="!reason"
...
export default {
  ...
  watch: {
    reason(val) {
      this.reasonLocal = val;
    },
  },
  computed: {
    reason: {
      get() {
        return this.reasonLocal;
      },
      set(value) {
        this.reasonLocal = value;
      },
    },
  },
  methods: {
