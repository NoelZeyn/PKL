  ...
  <div class="flex min-h-screen flex-col md:flex-row">
    ...
    <div class="w-full md:w-3/5 flex flex-col items-center pt-5 overflow-hidden">
      <div class="flex items-center gap-3 self-start ml-12 mb-10">
        ...
        <span class="logo-text text-[20px] font-bold text-[#08607a] font-['Protest_Strike']">System ATK PLN</span>
      </div>

      <div class="flex flex-col items-center text-center mb-5 w-[100%] max-w-md">
        <h2 class="text-3xl font-semibold mb-2 w-full">Register Akun System ATK PLN</h2>
        ...
        <form @submit.prevent="register" class="w-full">
          ...
          <div class="mb-4">
            ...
            <div class="relative">
              ...
              <p v-if="errors.password" class="text-left text-sm text-red-500 mt-1">{{ errors.password[0] }}</p>
            </div>
          </div>
        ...
        <p v-if="message" :class="messageClass + ' mt-3 text-sm'">{{ message }}</p>
